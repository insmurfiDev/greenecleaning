...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/new/globals.css') }}">
    @yield('styles')
    <link
        href="https://fonts.googleapis.com/css2?family=PT+Serif+Caption:ital@0;1&amp;family=Quicksand:wght@300;400;500;600;700&amp;display=swap">
            ...
            <div class="c-menu">
                ...
                <div class="c-nav mx-auto">
                    <a class="mx-3" target="_blank"
                        href="{{ \Illuminate\Support\Facades\Config::get('settings.facebook') }}">
                    ...
                    <a class="mx-3" target="_blank"
                        href="{{ \Illuminate\Support\Facades\Config::get('settings.twitter') }}">
                        <img class="vis" src="{{ asset('svg/icons/twitter.svg') }}" alt="twitter">
                        <img class="hid" src="{{ asset('svg/icons/twitter-hr.svg') }}" alt="twitter">
                    </a>
                </div>
                <div class="c-wa ml-auto"><a class="e-white e-up" href="https://webandad.com"> Powered by
                        Web<span>&amp;</span>Ad</a></div>
            </div>
        </div>
    </div>
